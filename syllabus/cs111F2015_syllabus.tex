%!TEX root=cs111F2015_syllabus.tex
...
then reserving an open time slot. Students are also strongly encouraged to post all of their questions to the
appropriate channel in Slack, which is available at \url{https://CMPSC111FALL2015.slack.com}.
...
Final Examination: Thursday, December 11, 2014 at 9:00 am
...
iteration while also discovering how to use single-dimension, multi-dimensional, and extendible arrays and to implement
graphical applications.  Students also will gain hands-on experience in the use, design, implementation, and testing of
software during the laboratory and practical sessions and a final project.  Moreover, students will enhance their ability to
...
implementing programs in Java.  That is, students should be comfortable with the use of Vim as an integrated
...
\begin{itemize}
  ...
  \item {\em Final Project}: This project will present you with the description of a problem and ask you to design
    ...
    apply all of the knowledge and skills that you have acquired during the course of the semester to solve a
