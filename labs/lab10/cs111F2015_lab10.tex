\input{111pre}
\begin{document}
\MYTITLE{Lab 10 \\ 11 November 2015\\
Due Wednesday, 18 November by 2:30pm }
...
``{\tt cs111F2015-<your user name>}'' repository inside the ``{\tt labs/}'' directory, create a directory called ``{\tt
