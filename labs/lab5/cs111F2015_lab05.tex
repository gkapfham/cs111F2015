...
\begin{enumerate}
  ...
  \item Prompt the user for word that is exactly ten characters long. For now, {\tt WordHide} should allow the user to
    enter any type of ``padding character'' before or after a word that is less than ten characters. If the word is
    longer than ten characters, then your program should simply discard all of the characters after the tenth one.

  \item Since the {\tt WordHide} program will output all of its character in a capitalized form, you should transform the
...
\begin{enumerate}
        ...
        \item A completed, properly commented and formatted {\tt WordHide.java} program. Please make sure that your Java
          ...
          program, in addition to displaying the lab number and the date on which the program was run.
