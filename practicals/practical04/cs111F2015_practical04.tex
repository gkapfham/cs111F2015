\input{111pre}
\begin{document}
\MYTITLE{Practical 4\\2 October 2015\\Due in Bitbucket by midnight of the day of your practical \\ ``Checkmark'' grade}
...
understand.  In addition to discussing these questions with the teaching assistants and a course instructor, try to
...
of course, you should create your (much better) own story!
...
\item {\bf Add and Example of Your ``Mad Lib'' to Slack.} Once you have finished your program and run it in the terminal
