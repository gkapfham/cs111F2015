...
\begin{document}
% \MYTITLE{Lab 1 \\ Assigned: Thursday, 4 September 2015 \\ Due: Thursday, 11 September 2015, 2:30 pm}
\MYTITLE{Practical 1\\4--5 September 2015\\Due: September 10, 2015 by the end of class\\``Checkmark'' grade}

% \begin{document}
% \MYTITLE{Laboratory Assignment One: Version Control with Git and Bitbucket}
% \MYHEADERS{Laboratory Assignment One}{Due: January 28, 2015}
...
\begin{enumerate}
  ...
  \item Now, you need to test to see if you can authenticate with the Bitbucket servers.  First, show the course
    ...
    git@bitbucket.org:janyljumadinova/cs111f2015-share.git}'', \newline {\bf or} the following command if you are in {\bf
